  ...
  (error) => {
    ...
    if (status === 401 || status === 403) {
      const isAuthPath =
        ...
        error.config?.url?.startsWith("/english/auth/");
...
export const apiService = {
  ...
  // 서버에서 현재 로그인된 사용자 정보 조회 (OAuth 콜백 후 사용)
  ...
  async generateExamples(word: string): Promise<ExampleResponse> {
    try {
      const response = await apiClient.post<ApiResponse<ExampleResponse>>(
        "/generate/examples",
        { word },
      );
      ...
      if (!response.data.success) {
        throw new Error(
          response.data.message || "유효한 영어 단어가 아닙니다.",
        );
      }
      ...
      if (error.response) {
        if (error.response.status === 400) {
          throw new Error(
            error.response.data?.message || "유효한 영어 단어가 아닙니다.",
          );
        }
  ...
  // 문제 생성
  async generateWritingProblems(
    topic: string,
    mode: "toeic" | "writing",
  ): Promise<ToeicResponse | WritingResponse> {
    try {
  ...
  async saveWord(data: SaveWordRequest): Promise<ApiResponse<WordDto>> {
    try {
      ...
      const response = await apiClient.post<ApiResponse<WordDto>>(
        "/words",
        data,
        {
      ...
      throw new Error(
        error.response?.data?.message || "단어 저장에 실패했습니다.",
      );
    }
  },
  ...
  // 예문 저장
  async saveExample(
    data: SaveExampleRequest,
  ): Promise<ApiResponse<ExampleDto>> {
    try {
      const response = await apiClient.post<ApiResponse<ExampleDto>>(
        "/examples",
        data,
      );
      return response.data;
      ...
      throw new Error(
        error.response?.data?.message || "예문 저장에 실패했습니다.",
      );
    }
  },
  ...
  async getWords(): Promise<WordDto[]> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "단어 목록을 불러오는데 실패했습니다.",
      );
    }
  },
  ...
  async getExamples(): Promise<ExampleDto[]> {
    try {
      const response =
        await apiClient.get<ApiResponse<ExampleDto[]>>("/examples");
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "예문 목록을 불러오는데 실패했습니다.",
      );
    }
  },
  ...
  async getExamplesByWord(wordId: number): Promise<ExampleDto[]> {
    try {
      const response = await apiClient.get<ApiResponse<ExampleDto[]>>(
        `/examples/word/${wordId}`,
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "예문 조회에 실패했습니다.",
      );
    }
  },
  ...
  async searchWords(keyword: string): Promise<WordDto[]> {
    try {
      const response = await apiClient.get<ApiResponse<WordDto[]>>(
        `/words/search?keyword=${encodeURIComponent(keyword)}`,
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "단어 검색에 실패했습니다.",
      );
    }
  },
  ...
  async searchExamples(keyword: string): Promise<ExampleDto[]> {
    try {
      const response = await apiClient.get<ApiResponse<ExampleDto[]>>(
        `/examples/search?keyword=${encodeURIComponent(keyword)}`,
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "예문 검색에 실패했습니다.",
      );
    }
  },
  ...
  async getWord(wordId: number): Promise<WordDto> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "단어 조회에 실패했습니다.",
      );
    }
  },
  ...
  async deleteWord(wordId: number): Promise<void> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "단어 삭제에 실패했습니다.",
      );
    }
  },
  ...
  async deleteExample(exampleId: number): Promise<void> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "예문 삭제에 실패했습니다.",
      );
    }
  },
  ...
  async getWordsCount(): Promise<number> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "단어 개수 조회에 실패했습니다.",
      );
    }
  },
  ...
  async getExamplesCount(): Promise<number> {
    try {
      const response =
        await apiClient.get<ApiResponse<number>>("/examples/count");
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "예문 개수 조회에 실패했습니다.",
      );
    }
  },
  ...
  async generateTTS(
    ...
    try {
      ...
      throw new Error(
        error.response?.data?.message || "TTS 생성에 실패했습니다.",
      );
    }
  },
  ...
  ): Promise<ApiResponse<SavedQuestionDto>> {
    try {
      const response = await apiClient.post<ApiResponse<SavedQuestionDto>>(
        "/questions",
        data,
      );
      return response.data;
      ...
      throw new Error(
        error.response?.data?.message || "문제 저장에 실패했습니다.",
      );
    }
  },
  ...
  async getQuestions(): Promise<SavedQuestionDto[]> {
    try {
      const response =
        await apiClient.get<ApiResponse<SavedQuestionDto[]>>("/questions");
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "문제 목록을 불러오는데 실패했습니다.",
      );
    }
  },
  ...
  async getToeicQuestions(): Promise<SavedQuestionDto[]> {
    try {
      const response =
        await apiClient.get<ApiResponse<SavedQuestionDto[]>>(
          "/questions/toeic",
        );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "토익 문제 조회에 실패했습니다.",
      );
    }
  },
  ...
  async getToeicQuestionsByPart(part: ToeicPart): Promise<SavedQuestionDto[]> {
    try {
      const response = await apiClient.get<ApiResponse<SavedQuestionDto[]>>(
        `/questions/toeic/${part}`,
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "문제 조회에 실패했습니다.",
      );
    }
  },
  ...
  async getWritingQuestions(): Promise<SavedQuestionDto[]> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "영작 문제 조회에 실패했습니다.",
      );
    }
  },
  ...
  async searchQuestions(topic: string): Promise<SavedQuestionDto[]> {
    try {
      const response = await apiClient.get<ApiResponse<SavedQuestionDto[]>>(
        `/questions/search?topic=${encodeURIComponent(topic)}`,
      );
      return response.data.data;
    } catch (error: any) {
  ...
  async deleteQuestion(id: number): Promise<void> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "문제 삭제에 실패했습니다.",
      );
    }
  },
  ...
  async getQuestionsCount(): Promise<number> {
    try {
      const response =
        await apiClient.get<ApiResponse<number>>("/questions/count");
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "문제 개수 조회에 실패했습니다.",
      );
    }
  },
  ...
  async getToeicQuestionsCount(): Promise<number> {
    try {
      const response = await apiClient.get<ApiResponse<number>>(
        "/questions/toeic/count",
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "토익 문제 개수 조회에 실패했습니다.",
      );
    }
  },
  ...
  async getWritingQuestionsCount(): Promise<number> {
    try {
      const response = await apiClient.get<ApiResponse<number>>(
        "/questions/writing/count",
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "영작 문제 개수 조회에 실패했습니다.",
      );
    }
  },
  ...
  async sendChatMessage(
    ...
    try {
      const response = await apiClient.post<
        ChatSuccessResponse<ChatMessageResponse>
      >("/chat/message", {
        message,
        conversationId,
      });
      ...
      if (error.response?.status === 500) {
        throw new Error(
          "챗봇 응답 생성에 실패했습니다. 잠시 후 다시 시도해주세요.",
        );
      }
      throw new Error(
  ...
  async getChatConversations(): Promise<ConversationSession[]> {
    try {
      const response = await apiClient.get<
        ChatSuccessResponse<ConversationSession[]>
      >("/chat/conversations");
      return response.data.data;
    } catch (error: any) {
      throw new Error(
        error.response?.data?.message || "대화 목록을 불러오는데 실패했습니다.",
      );
    }
  },
  ...
  async getChatHistory(conversationId: string): Promise<ConversationHistory> {
    try {
      const response = await apiClient.get<
        ChatSuccessResponse<ConversationHistory>
  ...
  async deleteChatConversation(conversationId: string): Promise<void> {
    try {
      ...
      throw new Error(
        error.response?.data?.message || "대화 삭제에 실패했습니다.",
      );
    }
  },
};
